...
var file_snapshot_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_snapshot_agent_proto_goTypes = []any{
	...
	(*MemoryRegion)(nil),               // 11: snapshot_agent.v1alpha1.MemoryRegion
	(*MemoryRegionsBackendConfig)(nil), // 12: snapshot_agent.v1alpha1.MemoryRegionsBackendConfig
	(*BackendConfig)(nil),              // 13: snapshot_agent.v1alpha1.BackendConfig
	(*WorkloadCapabilities)(nil),       // 14: snapshot_agent.v1alpha1.WorkloadCapabilities
	(*RegisterWorkload)(nil),           // 15: snapshot_agent.v1alpha1.RegisterWorkload
	(*CommandResult)(nil),              // 16: snapshot_agent.v1alpha1.CommandResult
	(*WorkloadMessage)(nil),            // 17: snapshot_agent.v1alpha1.WorkloadMessage
	(*SnapshotCommand)(nil),            // 18: snapshot_agent.v1alpha1.SnapshotCommand
	(*RestoreCommand)(nil),             // 19: snapshot_agent.v1alpha1.RestoreCommand
	(*AgentCommand)(nil),               // 20: snapshot_agent.v1alpha1.AgentCommand
	(*SnapshotRequest)(nil),            // 21: snapshot_agent.v1alpha1.SnapshotRequest
	(*SnapshotResponse)(nil),           // 22: snapshot_agent.v1alpha1.SnapshotResponse
	(*RestoreRequest)(nil),             // 23: snapshot_agent.v1alpha1.RestoreRequest
	(*RestoreResponse)(nil),            // 24: snapshot_agent.v1alpha1.RestoreResponse
	(*GetOperationRequest)(nil),        // 25: snapshot_agent.v1alpha1.GetOperationRequest
	(*GetOperationResponse)(nil),       // 26: snapshot_agent.v1alpha1.GetOperationResponse
	(*StatusRequest)(nil),              // 27: snapshot_agent.v1alpha1.StatusRequest
	(*JobStatus)(nil),                  // 28: snapshot_agent.v1alpha1.JobStatus
	(*AcceleratorStatus)(nil),          // 29: snapshot_agent.v1alpha1.AcceleratorStatus
	(*StatusResponse)(nil),             // 30: snapshot_agent.v1alpha1.StatusResponse
}
var file_snapshot_agent_proto_depIdxs = []int32{
	...
	11, // 6: snapshot_agent.v1alpha1.MemoryRegionsBackendConfig.regions:type_name -> snapshot_agent.v1alpha1.MemoryRegion
	6,  // 7: snapshot_agent.v1alpha1.BackendConfig.cuda:type_name -> snapshot_agent.v1alpha1.CudaBackendConfig
	9,  // 8: snapshot_agent.v1alpha1.BackendConfig.app_endpoint:type_name -> snapshot_agent.v1alpha1.AppEndpointConfig
	10, // 9: snapshot_agent.v1alpha1.BackendConfig.app_channel:type_name -> snapshot_agent.v1alpha1.AppChannelConfig
	7,  // 10: snapshot_agent.v1alpha1.BackendConfig.direct_memory:type_name -> snapshot_agent.v1alpha1.DirectMemoryBackendConfig
	12, // 11: snapshot_agent.v1alpha1.BackendConfig.memory_regions:type_name -> snapshot_agent.v1alpha1.MemoryRegionsBackendConfig
	8,  // 12: snapshot_agent.v1alpha1.BackendConfig.tpu:type_name -> snapshot_agent.v1alpha1.TpuBackendConfig
	...
	14, // 15: snapshot_agent.v1alpha1.RegisterWorkload.capabilities:type_name -> snapshot_agent.v1alpha1.WorkloadCapabilities
	15, // 16: snapshot_agent.v1alpha1.WorkloadMessage.register:type_name -> snapshot_agent.v1alpha1.RegisterWorkload
	16, // 17: snapshot_agent.v1alpha1.WorkloadMessage.result:type_name -> snapshot_agent.v1alpha1.CommandResult
	2,  // 18: snapshot_agent.v1alpha1.SnapshotCommand.mode:type_name -> snapshot_agent.v1alpha1.SuspendMode
	18, // 19: snapshot_agent.v1alpha1.AgentCommand.snapshot:type_name -> snapshot_agent.v1alpha1.SnapshotCommand
	19, // 20: snapshot_agent.v1alpha1.AgentCommand.restore:type_name -> snapshot_agent.v1alpha1.RestoreCommand
	0,  // 21: snapshot_agent.v1alpha1.SnapshotRequest.backend:type_name -> snapshot_agent.v1alpha1.Backend
	13, // 22: snapshot_agent.v1alpha1.SnapshotRequest.backend_config:type_name -> snapshot_agent.v1alpha1.BackendConfig
	0,  // 23: snapshot_agent.v1alpha1.RestoreRequest.backend:type_name -> snapshot_agent.v1alpha1.Backend
	13, // 24: snapshot_agent.v1alpha1.RestoreRequest.backend_config:type_name -> snapshot_agent.v1alpha1.BackendConfig
	3,  // 25: snapshot_agent.v1alpha1.GetOperationResponse.status:type_name -> snapshot_agent.v1alpha1.OperationStatus
	4,  // 26: snapshot_agent.v1alpha1.JobStatus.state:type_name -> snapshot_agent.v1alpha1.JobState
	28, // 27: snapshot_agent.v1alpha1.StatusResponse.job_statuses:type_name -> snapshot_agent.v1alpha1.JobStatus
	29, // 28: snapshot_agent.v1alpha1.StatusResponse.accelerator_statuses:type_name -> snapshot_agent.v1alpha1.AcceleratorStatus
	21, // 29: snapshot_agent.v1alpha1.SnapshotAgentService.Snapshot:input_type -> snapshot_agent.v1alpha1.SnapshotRequest
	23, // 30: snapshot_agent.v1alpha1.SnapshotAgentService.Restore:input_type -> snapshot_agent.v1alpha1.RestoreRequest
	25, // 31: snapshot_agent.v1alpha1.SnapshotAgentService.GetOperation:input_type -> snapshot_agent.v1alpha1.GetOperationRequest
	27, // 32: snapshot_agent.v1alpha1.SnapshotAgentService.Status:input_type -> snapshot_agent.v1alpha1.StatusRequest
	17, // 33: snapshot_agent.v1alpha1.SnapshotAgentService.WorkloadChannel:input_type -> snapshot_agent.v1alpha1.WorkloadMessage
	22, // 34: snapshot_agent.v1alpha1.SnapshotAgentService.Snapshot:output_type -> snapshot_agent.v1alpha1.SnapshotResponse
	24, // 35: snapshot_agent.v1alpha1.SnapshotAgentService.Restore:output_type -> snapshot_agent.v1alpha1.RestoreResponse
	26, // 36: snapshot_agent.v1alpha1.SnapshotAgentService.GetOperation:output_type -> snapshot_agent.v1alpha1.GetOperationResponse
	30, // 37: snapshot_agent.v1alpha1.SnapshotAgentService.Status:output_type -> snapshot_agent.v1alpha1.StatusResponse
	20, // 38: snapshot_agent.v1alpha1.SnapshotAgentService.WorkloadChannel:output_type -> snapshot_agent.v1alpha1.AgentCommand
...
func file_snapshot_agent_proto_init() {
	...
	file_snapshot_agent_proto_msgTypes[21].OneofWrappers = []any{}
	type x struct{}
