...
Required verl config for time-sliced runs (hydra overrides):
  ...
  ray_pg_extra_resources.trainer_pool='{trainer_node: 1}'
  ray_pg_extra_resources.rollout_pool='{rollout_node: 1}'
"""
...
class TimesliceHooksMixin:
    ...
    def __init__(self, client_factory=None):
        ...
        self._locks: Optional[PhaseLocks] = None
